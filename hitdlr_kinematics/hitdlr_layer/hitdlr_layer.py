...
if __name__ == "__main__":
    ...
    # theta[0, 2] = 0.0
    # theta[0, 3] = 0.0
    mesh = hit.get_forward_hand_mesh(pose, theta, save_mesh=False, path='./output_mesh')
